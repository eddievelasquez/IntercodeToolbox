...
public readonly partial struct Test
  : global::Intercode.Toolbox.TypedPrimitives.IValueTypedPrimitive<float, Test>,
    global::System.IComparable<Test>,
    global::System.IComparable<float>,
...
#endif
{
  ...
  private float GetWrappedValueUnsafe()
  {
  ...
  public float? ValueOrDefault => GetValueOrDefault();
  ...
  public static Test CreateOrThrow( float? value )
  {
  ...
  public static void ValidateOrThrow( float? value )
  {
    var result = Validate( value );
    if( result.IsSuccess )
    {
  ...
  {
    var value = float.Parse( text, formatProvider );
    return CreateOrThrow( value );
  }
  ...
  public static bool TryParse(
    ...
    out Test result )
  {
    if ( !float.TryParse( text, formatProvider, out var value ) )
    {
      result = default;
      return false;
    }
    ...
    object? obj )
  {
    return obj switch
    {
      ...
      float value => CompareTo( value ),
      _ => throw new global::System.ArgumentException( "Object is not a Test or float" )
    };
  }
