...
public class DecimalPrimitiveTests
{
  ...
  private static readonly decimal s_validValueA = 42.0m;
  private static readonly decimal s_validValueB = 43.0m;
  ...
  {
    // Arrange
    var a = ( DecimalPrimitive ) s_validValueA;
    var b = ( DecimalPrimitive ) default;
  ...
  public void CompareTo_DifferentObjectValues_ReturnsComparisonResult()
  {
    ...
    // Arrange
    var a = ( DecimalPrimitive ) valueA;
    var b = ( DecimalPrimitive ) valueB;
  ...
  {
    // Arrange
    var primitive = ( DecimalPrimitive ) s_validValueA;
  ...
  public void Equals_DifferentValues_ReturnsFalse()
  {
    // Arrange
    var a = ( DecimalPrimitive ) s_validValueA;
    var b = ( DecimalPrimitive ) s_validValueB;
  ...
  public void Equals_SameValue_ReturnsTrue()
  {
    // Arrange
    var a = ( DecimalPrimitive ) s_validValueA;
    var b = ( DecimalPrimitive ) s_validValueA;
  ...
  {
    // Arrange
    var primitive = ( DecimalPrimitive ) default;
  ...
  public void ExplicitOperator_PrimitiveToString_ReturnsString()
  {
    ...
    var primitive = ( DecimalPrimitive ) value;
  ...
  {
    // Act
    var act = () => ( DecimalPrimitive ) value;

    // Assert
    act.Should()
       .Throw<InvalidOperationException>()
       .WithMessage( DecimalPrimitive.ExpectedValidationErrorMessage );
  }
  ...
  public void FromInt32_WithValidValue_ReturnsSuccess()
  {
    // Act
    var value = s_validValueA;
    var result = DecimalPrimitive.Create( value );
    ...
    decimal? value )
  {
    ...
    result.Errors.Select( error => error.Message )
          ...
          .Which
          .Should()
          .Be( DecimalPrimitive.ExpectedValidationErrorMessage );
  }
  ...
  {
    // Act
    var hashCodeA = ( ( DecimalPrimitive ) default ).GetHashCode();
  ...
  public void GetHashCode_SameValue_ReturnsSameHashCode()
  {
    // Arrange
    var value = s_validValueA;
    var a = ( DecimalPrimitive ) value;
    var b = ( DecimalPrimitive ) value;
  ...
  {
    // Act
    var isValid = DecimalPrimitive.IsValid( value );
  ...
  {
    // Act
    var isValid = DecimalPrimitive.IsValid( s_validValueA );
  ...
  {
    var value = s_validValueA;
    var test = new JsonTestClass { Primitive = ( DecimalPrimitive ) value };
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( DecimalPrimitive ) );
    converter.CanConvertFrom( typeof( decimal ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( DecimalPrimitive ) );
    var result = ( DecimalPrimitive ) converter.ConvertFrom( null! )!;

    result.Should()
          .BeOfType<DecimalPrimitive>()
          .Which.Should()
          .Be( default );
  }
  ...
  public void TypeConverter_ConvertTo_SupportedType_Succeeds()
  {
    ...
    var value = s_validValueA;
    var primitive = ( DecimalPrimitive ) value;
    var result = converter.ConvertTo( null, null, primitive, typeof( decimal ) );
  ...
  {
    // Act
    var result = DecimalPrimitive.Validate( value );
  ...
  {
    // Act
    var result = DecimalPrimitive.Validate( s_validValueA );
  ...
  {
    // Act
    var result = UnvalidatedDecimalPrimitive.Validate( value );
  ...
  public void ValueConverter_WithValidValue_Succeeds()
  {
    ...
    {
      Id = id,
      Primitive = ( DecimalPrimitive ) value
    };
  ...
  internal class JsonTestClass
  {
    ...
    public DecimalPrimitive Primitive { get; set; }
  ...
  internal class TestDbContext: DbContext
  {
      ...
      ModelBuilder modelBuilder )
    {
      modelBuilder.Entity<TestEntity>()
                  ...
                  .HasConversion( new DecimalPrimitiveValueConverter() )
                  .ValueGeneratedNever();
    }
