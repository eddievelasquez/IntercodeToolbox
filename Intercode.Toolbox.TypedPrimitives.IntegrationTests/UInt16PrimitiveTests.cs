...
public class UInt16PrimitiveTests
{
  ...
  private static readonly ushort s_validValueA = 42;
  private static readonly ushort s_validValueB = 43;
  ...
  {
    // Arrange
    var a = ( UInt16Primitive ) s_validValueA;
    var b = ( UInt16Primitive ) default;
  ...
  public void CompareTo_DifferentObjectValues_ReturnsComparisonResult()
  {
    ...
    // Arrange
    var a = ( UInt16Primitive ) valueA;
    var b = ( UInt16Primitive ) valueB;
  ...
  {
    // Arrange
    var primitive = ( UInt16Primitive ) s_validValueA;
  ...
  public void Equals_DifferentValues_ReturnsFalse()
  {
    // Arrange
    var a = ( UInt16Primitive ) s_validValueA;
    var b = ( UInt16Primitive ) s_validValueB;
  ...
  public void Equals_SameValue_ReturnsTrue()
  {
    // Arrange
    var a = ( UInt16Primitive ) s_validValueA;
    var b = ( UInt16Primitive ) s_validValueA;
  ...
  {
    // Arrange
    var primitive = ( UInt16Primitive ) default;
  ...
  public void ExplicitOperator_PrimitiveToString_ReturnsString()
  {
    ...
    var primitive = ( UInt16Primitive ) value;
  ...
  {
    // Act
    var act = () => ( UInt16Primitive ) value;

    // Assert
    act.Should()
       .Throw<InvalidOperationException>()
       .WithMessage( UInt16Primitive.ExpectedValidationErrorMessage );
  }
  ...
  {
    // Act
    var result = UInt16Primitive.Create( value );
    ...
    result.Errors.Select( error => error.Message )
          ...
          .Which
          .Should()
          .Be( UInt16Primitive.ExpectedValidationErrorMessage );
  }

  [Fact]
  public void FromUInt16_WithValidValue_ReturnsSuccess()
  {
    // Act
    var value = s_validValueA;
    var result = UInt16Primitive.Create( value );
  ...
  {
    // Act
    var hashCodeA = ( ( UInt16Primitive ) default ).GetHashCode();
  ...
  public void GetHashCode_SameValue_ReturnsSameHashCode()
  {
    // Arrange
    var value = s_validValueA;
    var a = ( UInt16Primitive ) value;
    var b = ( UInt16Primitive ) value;
  ...
  {
    // Act
    var isValid = UInt16Primitive.IsValid( value );
  ...
  {
    // Act
    var isValid = UInt16Primitive.IsValid( s_validValueA );
  ...
  {
    var value = s_validValueA;
    var test = new JsonTestClass { Primitive = ( UInt16Primitive ) value };
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( UInt16Primitive ) );
    converter.CanConvertFrom( typeof( ushort ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( UInt16Primitive ) );
    var result = ( UInt16Primitive ) converter.ConvertFrom( null! )!;

    result.Should()
          .BeOfType<UInt16Primitive>()
          .Which.Should()
          .Be( default );
  }
  ...
  public void TypeConverter_ConvertTo_SupportedType_Succeeds()
  {
    ...
    var value = s_validValueA;
    var primitive = ( UInt16Primitive ) value;
    var result = converter.ConvertTo( null, null, primitive, typeof( ushort ) );
  ...
  {
    // Act
    var result = UInt16Primitive.Validate( value );
  ...
  {
    // Act
    var result = UInt16Primitive.Validate( s_validValueA );
  ...
  {
    // Act
    var result = UnvalidatedUInt16Primitive.Validate( value );
  ...
  public void ValueConverter_WithValidValue_Succeeds()
  {
    ...
    {
      Id = id,
      Primitive = ( UInt16Primitive ) value
    };
  ...
  internal class JsonTestClass
  {
    ...
    public UInt16Primitive Primitive { get; set; }
  ...
  internal class TestDbContext: DbContext
  {
      ...
      ModelBuilder modelBuilder )
    {
      modelBuilder.Entity<TestEntity>()
                  ...
                  .HasConversion( new UInt16PrimitiveValueConverter() )
                  .ValueGeneratedNever();
    }
