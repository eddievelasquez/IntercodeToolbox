// Module Name: IntPrimitiveSourceGenerationTests.cs
...
public class IntPrimitiveSourceGenerationTests( ITestOutputHelper output )
{
  ...
  public Task Compilation_ShouldSucceed_WithExplicitConverters()
  {
    var source = """
        ...
        [TypedPrimitive(typeof( int ), Converters = TypedPrimitiveConverter.TypeConverter | TypedPrimitiveConverter.SystemTextJson | TypedPrimitiveConverter.EfCoreValueConverter)]
