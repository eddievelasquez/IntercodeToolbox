...
public class SBytePrimitiveTests
{
  ...
  private static readonly sbyte s_validValueA = 42;
  private static readonly sbyte s_validValueB = -43;
  ...
  {
    // Arrange
    var a = ( SBytePrimitive ) s_validValueA;
    var b = ( SBytePrimitive ) default;
  ...
  public void CompareTo_DifferentObjectValues_ReturnsComparisonResult()
  {
    ...
    // Arrange
    var a = ( SBytePrimitive ) valueA;
    var b = ( SBytePrimitive ) valueB;
  ...
  {
    // Arrange
    var primitive = ( SBytePrimitive ) s_validValueA;
  ...
  {
    // Act
    var result = SBytePrimitive.Create( value );
    ...
    result.Errors.Select( error => error.Message )
          ...
          .Which
          .Should()
          .Be( SBytePrimitive.ExpectedValidationErrorMessage );
  }
  ...
  public void Equals_DifferentValues_ReturnsFalse()
  {
    // Arrange
    var a = ( SBytePrimitive ) s_validValueA;
    var b = ( SBytePrimitive ) s_validValueB;
  ...
  public void Equals_SameValue_ReturnsTrue()
  {
    // Arrange
    var a = ( SBytePrimitive ) s_validValueA;
    var b = ( SBytePrimitive ) s_validValueA;
  ...
  {
    // Arrange
    var primitive = ( SBytePrimitive ) default;
  ...
  public void ExplicitOperator_PrimitiveToString_ReturnsString()
  {
    // Arrange
    var value = s_validValueA;
    var primitive = ( SBytePrimitive ) value;
  ...
  {
    // Act
    var act = () => ( SBytePrimitive ) value;

    // Assert
    act.Should()
       .Throw<InvalidOperationException>()
       .WithMessage( SBytePrimitive.ExpectedValidationErrorMessage );
  }
  ...
  {
    // Act
    var hashCodeA = ( ( SBytePrimitive ) default ).GetHashCode();
  ...
  public void GetHashCode_SameValue_ReturnsSameHashCode()
  {
    // Arrange
    var value = s_validValueA;
    var a = ( SBytePrimitive ) value;
    var b = ( SBytePrimitive ) value;
  ...
  {
    // Act
    var isValid = SBytePrimitive.IsValid( value );
  ...
  {
    // Act
    var isValid = SBytePrimitive.IsValid( s_validValueA );
  ...
  {
    var value = s_validValueA;
    var test = new JsonTestClass { Primitive = ( SBytePrimitive ) value };
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( SBytePrimitive ) );
    converter.CanConvertFrom( typeof( sbyte ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( SBytePrimitive ) );
    var result = ( SBytePrimitive ) converter.ConvertFrom( null! )!;

    result.Should()
          .BeOfType<SBytePrimitive>()
          .Which.Should()
          .Be( default );
  }
  ...
  public void TypeConverter_ConvertTo_SupportedType_Succeeds()
  {
    ...
    var value = s_validValueA;
    var primitive = ( SBytePrimitive ) value;
    var result = converter.ConvertTo( null, null, primitive, typeof( sbyte ) );
  ...
  {
    // Act
    var result = SBytePrimitive.Validate( value );
  ...
  {
    // Act
    var result = SBytePrimitive.Validate( s_validValueA );
  ...
  {
    // Act
    var result = UnvalidatedSBytePrimitive.Validate( value );
  ...
  public void ValueConverter_WithValidValue_Succeeds()
  {
    ...
    {
      Id = id,
      Primitive = ( SBytePrimitive ) value
    };
  ...
  internal class JsonTestClass
  {
    ...
    public SBytePrimitive Primitive { get; set; }
  ...
  internal class TestDbContext: DbContext
  {
      ...
      ModelBuilder modelBuilder )
    {
      modelBuilder.Entity<TestEntity>()
                  ...
                  .HasConversion( new SBytePrimitiveValueConverter() )
                  .ValueGeneratedNever();
    }
