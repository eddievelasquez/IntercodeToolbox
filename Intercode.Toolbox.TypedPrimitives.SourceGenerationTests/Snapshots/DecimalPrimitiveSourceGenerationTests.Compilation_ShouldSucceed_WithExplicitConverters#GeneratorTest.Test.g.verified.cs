...
public readonly partial struct Test
  : global::Intercode.Toolbox.TypedPrimitives.IValueTypedPrimitive<double, Test>,
...
#endif
{
  ...
  private double GetWrappedValueUnsafe()
  {
  ...
  public double? ValueOrDefault => GetValueOrDefault();
  ...
  public static Test CreateOrThrow( double? value )
  {
  ...
  public static void ValidateOrThrow( double? value )
  {
    var result = Validate( value );
    if( result.IsSuccess )
    {
  ...
  {
    var value = double.Parse( text, formatProvider );
    return CreateOrThrow( value );
  }
  ...
  public static bool TryParse(
    ...
    out Test result )
  {
    if ( !double.TryParse( text, formatProvider, out var value ) )
    {
      result = default;
      return false;
    }
