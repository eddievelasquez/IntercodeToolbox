...
public class SinglePrimitiveTests
{
  ...
  public class Comparable
    : ComparableTests<SinglePrimitive, Comparable>,
      ITestDataFactory
  {
  ...
  public class ComparableOfT
    : ComparableOfTTests<SinglePrimitive, ComparableOfT>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class Creation
    : ValuePrimitiveCreationTests<float, SinglePrimitive, ValueFactory>;

  public new class Equals
    : EqualsTests<SinglePrimitive, Equals>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public new class GetHashCode
    : GetHashCodeTests<SinglePrimitive, GetHashCode>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class NewtonsoftJson
    : NewtonsoftJsonTests<SinglePrimitive, PrimitiveFactory>;
  ...
  public class SpanFormattable
    : SpanFormattableTests<SinglePrimitive, SpanFormattable>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class SpanParsable
    : SpanParsableTests<SinglePrimitive, SpanParsable>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class SystemTextJson
    : SystemTextJsonTests<SinglePrimitive, PrimitiveFactory>;
  ...
  public class UnvalidatedValidation
    : UnvalidatedValuePrimitiveValidationTests<float, UnvalidatedSinglePrimitive, ValueFactory>;
  ...
  private static readonly float s_valueA = 42.0f;
  private static readonly float s_valueB = 43.0f;
  private static readonly SinglePrimitive s_primitiveA = SinglePrimitive.CreateOrThrow( s_valueA );
  private static readonly SinglePrimitive s_primitiveB = SinglePrimitive.CreateOrThrow( s_valueB );
  private static readonly SinglePrimitive s_defaultPrimitive = default;
