...
public class UInt32PrimitiveTests
{
  ...
  private static readonly uint s_validValueA = 42;
  private static readonly uint s_validValueB = 43;
  ...
  {
    // Arrange
    var a = ( UInt32Primitive ) s_validValueA;
    var b = ( UInt32Primitive ) default;
  ...
  public void CompareTo_DifferentObjectValues_ReturnsComparisonResult()
  {
    ...
    // Arrange
    var a = ( UInt32Primitive ) valueA;
    var b = ( UInt32Primitive ) valueB;
  ...
  {
    // Arrange
    var primitive = ( UInt32Primitive ) s_validValueA;
  ...
  public void Equals_DifferentValues_ReturnsFalse()
  {
    // Arrange
    var a = ( UInt32Primitive ) s_validValueA;
    var b = ( UInt32Primitive ) s_validValueB;
  ...
  public void Equals_SameValue_ReturnsTrue()
  {
    // Arrange
    var a = ( UInt32Primitive ) s_validValueA;
    var b = ( UInt32Primitive ) s_validValueA;
  ...
  {
    // Arrange
    var primitive = ( UInt32Primitive ) default;
  ...
  public void ExplicitOperator_PrimitiveToString_ReturnsString()
  {
    ...
    var primitive = ( UInt32Primitive ) value;
  ...
  {
    // Act
    var act = () => ( UInt32Primitive ) value;

    // Assert
    act.Should()
       .Throw<InvalidOperationException>()
       .WithMessage( UInt32Primitive.ExpectedValidationErrorMessage );
  }
  ...
  {
    // Act
    var result = UInt32Primitive.Create( value );
    ...
    result.Errors.Select( error => error.Message )
          ...
          .Which
          .Should()
          .Be( UInt32Primitive.ExpectedValidationErrorMessage );
  }

  [Fact]
  public void FromUInt32_WithValidValue_ReturnsSuccess()
  {
    // Act
    var value = s_validValueA;
    var result = UInt32Primitive.Create( value );
  ...
  {
    // Act
    var hashCodeA = ( ( UInt32Primitive ) default ).GetHashCode();
  ...
  public void GetHashCode_SameValue_ReturnsSameHashCode()
  {
    // Arrange
    var value = s_validValueA;
    var a = ( UInt32Primitive ) value;
    var b = ( UInt32Primitive ) value;
  ...
  {
    // Act
    var isValid = UInt32Primitive.IsValid( value );
  ...
  {
    // Act
    var isValid = UInt32Primitive.IsValid( s_validValueA );
  ...
  {
    var value = s_validValueA;
    var test = new JsonTestClass { Primitive = ( UInt32Primitive ) value };
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( UInt32Primitive ) );
    converter.CanConvertFrom( typeof( uint ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( UInt32Primitive ) );
    converter.CanConvertTo( typeof( uint ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( UInt32Primitive ) );
    var result = ( UInt32Primitive ) converter.ConvertFrom( null! )!;

    result.Should()
          .BeOfType<UInt32Primitive>()
          .Which.Should()
          .Be( default );
  }
  ...
  public void TypeConverter_ConvertTo_SupportedType_Succeeds()
  {
    ...
    var value = s_validValueA;
    var primitive = ( UInt32Primitive ) value;
    var result = converter.ConvertTo( null, null, primitive, typeof( uint ) );
  ...
  {
    // Act
    var result = UInt32Primitive.Validate( value );
  ...
  {
    // Act
    var result = UInt32Primitive.Validate( s_validValueA );
  ...
  {
    // Act
    var result = UnvalidatedUInt32Primitive.Validate( value );
  ...
  public void ValueConverter_WithValidValue_Succeeds()
  {
    ...
    {
      Id = id,
      Primitive = ( UInt32Primitive ) value
    };
  ...
  internal class JsonTestClass
  {
    ...
    public UInt32Primitive Primitive { get; set; }
  ...
  internal class TestDbContext: DbContext
  {
      ...
      ModelBuilder modelBuilder )
    {
      modelBuilder.Entity<TestEntity>()
                  ...
                  .HasConversion( new UInt32PrimitiveValueConverter() )
                  .ValueGeneratedNever();
    }
