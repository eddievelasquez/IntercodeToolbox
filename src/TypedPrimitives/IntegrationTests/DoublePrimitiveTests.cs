...
public class DoublePrimitiveTests
{
  ...
  public class Comparable
    : ComparableTests<DoublePrimitive, Comparable>,
      ITestDataFactory
  {
  ...
  public class ComparableOfT
    : ComparableOfTTests<DoublePrimitive, ComparableOfT>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class Creation
    : ValuePrimitiveCreationTests<double, DoublePrimitive, ValueFactory>;

  public new class Equals
    : EqualsTests<DoublePrimitive, Equals>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public new class GetHashCode
    : GetHashCodeTests<DoublePrimitive, GetHashCode>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class NewtonsoftJson
    : NewtonsoftJsonTests<DoublePrimitive, PrimitiveFactory>;
  ...
  public class SpanFormattable
    : SpanFormattableTests<DoublePrimitive, SpanFormattable>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class SpanParsable
    : SpanParsableTests<DoublePrimitive, SpanParsable>,
      ITestDataFactory
  {
    #region Public Methods
  ...
  public class SystemTextJson
    : SystemTextJsonTests<DoublePrimitive, PrimitiveFactory>;
  ...
  public class UnvalidatedValidation
    : UnvalidatedValuePrimitiveValidationTests<double, UnvalidatedDoublePrimitive, ValueFactory>;

  public class Validation
    : ValuePrimitiveValidationTests<double, DoublePrimitive, ValueFactory>;

  public class ValueConverter
    : ValueConverterTests<DoublePrimitive, DoublePrimitiveEFCoreValueConverter, PrimitiveFactory>;
  ...
  private static readonly double s_valueA = 42.0;
  private static readonly double s_valueB = 43.0;
  private static readonly DoublePrimitive s_primitiveA = DoublePrimitive.CreateOrThrow( s_valueA );
  private static readonly DoublePrimitive s_primitiveB = DoublePrimitive.CreateOrThrow( s_valueB );
  private static readonly DoublePrimitive s_defaultPrimitive = default;
