// Module Name: MutableListLookupTests.cs
...
public class MutableListLookupTests
{
  #region Tests

  [Fact]
  public void Add_WithValue_ShouldReturnTrue_WhenAddingExistingValue()
  {
    var lookup = new MutableListLookup<int, string>() { { 1, "Value1" } };
  ...
  {
    var lookup = new MutableListLookup<int, string>();
  ...
  public void Ctor_WithCapacity_ShouldSucceed_WhenCapacityIsNotNegative(
    int capacity )
  {
    var act = () => new MutableListLookup<string, string>( capacity );
  ...
  {
    var act = () => new MutableListLookup<string, string>( -2 );
  ...
  public void Ctor_WithCapacityAndComparer_ShouldSucceed_WhenCapacityIsNotNegative(
    int capacity )
  {
    var act = () => new MutableListLookup<string, string>( capacity, StringComparer.OrdinalIgnoreCase );
  ...
  {
    var act = () => new MutableListLookup<string, string>( -2, StringComparer.OrdinalIgnoreCase );
  ...
  {
    var lookup = new MutableListLookup<string, string>( 2, StringComparer.OrdinalIgnoreCase );
