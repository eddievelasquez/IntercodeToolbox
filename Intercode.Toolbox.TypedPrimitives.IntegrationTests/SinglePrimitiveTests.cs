...
public class SinglePrimitiveTests
{
  ...
  private static readonly float s_validValueA = 42.0f;
  private static readonly float s_validValueB = 43.0f;
  ...
  {
    // Arrange
    var a = ( SinglePrimitive ) s_validValueA;
    var b = ( SinglePrimitive ) default;
  ...
  public void CompareTo_DifferentObjectValues_ReturnsComparisonResult()
  {
    ...
    // Arrange
    var a = ( SinglePrimitive ) valueA;
    var b = ( SinglePrimitive ) valueB;
  ...
  {
    // Arrange
    var primitive = ( SinglePrimitive ) s_validValueA;
  ...
  public void Equals_DifferentValues_ReturnsFalse()
  {
    // Arrange
    var a = ( SinglePrimitive ) s_validValueA;
    var b = ( SinglePrimitive ) s_validValueB;
  ...
  public void Equals_SameValue_ReturnsTrue()
  {
    // Arrange
    var a = ( SinglePrimitive ) s_validValueA;
    var b = ( SinglePrimitive ) s_validValueA;
  ...
  {
    // Arrange
    var primitive = ( SinglePrimitive ) default;
  ...
  public void ExplicitOperator_PrimitiveToString_ReturnsString()
  {
    ...
    var primitive = ( SinglePrimitive ) value;
  ...
  {
    // Act
    var act = () => ( SinglePrimitive ) value;

    // Assert
    act.Should()
       .Throw<InvalidOperationException>()
       .WithMessage( SinglePrimitive.ExpectedValidationErrorMessage );
  }
  ...
  public void FromInt32_WithValidValue_ReturnsSuccess()
  {
    // Act
    var value = s_validValueA;
    var result = SinglePrimitive.Create( value );
    ...
    float? value )
  {
    ...
    result.Errors.Select( error => error.Message )
          ...
          .Which
          .Should()
          .Be( SinglePrimitive.ExpectedValidationErrorMessage );
  }
  ...
  {
    // Act
    var hashCodeA = ( ( SinglePrimitive ) default ).GetHashCode();
  ...
  public void GetHashCode_SameValue_ReturnsSameHashCode()
  {
    // Arrange
    var value = s_validValueA;
    var a = ( SinglePrimitive ) value;
    var b = ( SinglePrimitive ) value;
  ...
  {
    // Act
    var isValid = SinglePrimitive.IsValid( value );
  ...
  {
    // Act
    var isValid = SinglePrimitive.IsValid( s_validValueA );
  ...
  {
    var value = s_validValueA;
    var test = new JsonTestClass { Primitive = ( SinglePrimitive ) value };
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( SinglePrimitive ) );
    converter.CanConvertFrom( typeof( float ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( SinglePrimitive ) );
    converter.CanConvertTo( typeof( float ) )
             .Should()
             .BeTrue();
  }
  ...
  {
    var converter = TypeDescriptor.GetConverter( typeof( SinglePrimitive ) );
    var result = ( SinglePrimitive ) converter.ConvertFrom( null! )!;

    result.Should()
          .BeOfType<SinglePrimitive>()
          .Which.Should()
          .Be( default );
  }
  ...
  public void TypeConverter_ConvertTo_SupportedType_Succeeds()
  {
    ...
    var value = s_validValueA;
    var primitive = ( SinglePrimitive ) value;
    var result = converter.ConvertTo( null, null, primitive, typeof( float ) );
  ...
  {
    // Act
    var result = SinglePrimitive.Validate( value );
  ...
  {
    // Act
    var result = SinglePrimitive.Validate( s_validValueA );
  ...
  {
    // Act
    var result = UnvalidatedSinglePrimitive.Validate( value );
  ...
  public void ValueConverter_WithValidValue_Succeeds()
  {
    ...
    {
      Id = id,
      Primitive = ( SinglePrimitive ) value
    };
  ...
  internal class JsonTestClass
  {
    ...
    public SinglePrimitive Primitive { get; set; }
  ...
  internal class TestDbContext: DbContext
  {
      ...
      ModelBuilder modelBuilder )
    {
      modelBuilder.Entity<TestEntity>()
                  ...
                  .HasConversion( new SinglePrimitiveValueConverter() )
                  .ValueGeneratedNever();
    }
